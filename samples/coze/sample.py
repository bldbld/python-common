...
os.environ['RUN_STEP_BY_STEP'] = 'True'
...
if os.getenv("RUN_STEP_BY_STEP"):
    ...
    chat = coze.chat.create(
        ...
        user_id=user_id,
        additional_messages=[
            Message.build_user_question_text("我单位出租设备一套，合同签订期限为2年，租金共计100万元，本年收到租金50万元，税后为45.8万元，本期实收出租（借）收益，如何填列？")
            # Message.build_assistant_answer("财政业务专家"),
        ],
    )
